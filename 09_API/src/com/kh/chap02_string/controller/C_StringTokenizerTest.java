...
public class C_StringTokenizerTest {
	...
	public void method() {
		...
		*/
		...
		System.out.println(stn.countTokens());//NoSuchElementException : 더이상 뽑을 요소가 없다....
		*/
		...
		*/
		...
		//해결방법2
		while(stn.hasMoreTokens()) {  //반복 수행될 조건 : 토근이 남아있을때문 출력
			System.out.println(stn.nextToken());
		}
