...
public class PropertiesRun1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//ClassCastException
			//내부적으로 store 실행시 Properties에 담겨 있는 키 + 벨류 세트로 String 형변환해서 출력함
		...
		*/
		...
		System.out.println(prop); // 저장 순서 유지 안됨, key값이 중복이 되면 덮여씌워짐
		
		//2. getProperty(String key) : String
		System.out.println(prop.getProperty("List"));
		
		System.out.println(prop.getProperty("새우깡"));//존재하지 않는 키 값을 제시하면 null반환
