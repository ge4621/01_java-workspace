...
public class C_Arithmetic {
	...
	public void method1() {
		...
		//System.out.println("num1 + num 2 = " + num1 + num2); //103이 나옴..
		System.out.println("num1 + num2 = " + (num1 +num2)); //13
		//System.out.println("num1 - num2 = " + num1 - num2); //에러 발생
		System.out.println("num1 - num2 = "+ (num1-num2)); //7
		System.out.println("num1 * num2 = " + (num1*num2)); //30, 곱셈연산은 우선순위가 먼저! 가독성 위해()사용
		System.out.println("num1 / num2 = " + (num1 / num2)); //나누기 연산시 몫 출력
		System.out.println("num1 % num2 = " + (num1 % num2)); //나누기 연산시 나머지 출력 <짝홀>
		...
		public void quiz1(){
		      ...
		      //i = 6+9/(15/4)*(11-1)%(6+2) = 6 + 9 / 3 * 10 % 8= 6 + 3 * 10 % 8 = 6 + 30 % 8 =6+6=12
