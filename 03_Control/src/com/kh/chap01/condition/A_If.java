...
public class A_If {
	...
	public void method4() {
		...
		System.out.print("나이(숫자)를 입력하세요 : ");
		int num = sc.nextInt();
		/*
		if(num<=13) {
			System.out.println("어린이");
		}else if(num <=19) {  //13살 보다는 많고 19살 이하
	...
	public void method5() {
		...
		*/
		...
		String result = ""; //변수를 미리 세팅해둘 때 반드시 초기화 해놓는 습관을 들이기
		if(gender == 'M' ||gender =='m') {
			result = "남학생";
		}else if(gender =='F' ||gender =='f') {
			result = "여학생";
	...
	public void method6() {
		...
		if(name == "차은우") {
			...
			System.out.println("차은우님이 아니신가봐요. 안녕히가세요");
		}
		*/
		/*
		 *     			1		1	 2		4	 8	  4		8		2
