...
public class A_StringPoolTest {
	...
	int a = 10; //기본 자료형
		...
		System.out.println(str1 == str2); //주소값을 비교하니까 당연히 false
		System.out.println(str1.equals(str2));  //무조건 equals로 비교해야한다.!!!
		//String클래스에 equals 메소드 이미 오버라이딩 되어있다.!!!
		//Object 클래스 확인해보면 원래는 주소값을 동등비교하는 메소드이다.!!
		
		System.out.println(str1.hashCode());
		System.out.println(str2.hashCode());
		//String클래스에 hashCode메소드가 이미 오버라이딩 되어 있다.(주소값이 아닌 실제 담겨있는 문자열(hello)을 가지고 해쉬코그를 만들었다.)
		...
		public void method2() {
			...
			str3 = "bye";
			System.out.println(System.identityHashCode(str3));
			//변경을 하는 순간 기존의 문자열 자리에서 변경되는게 아닌
			//새로운 곳을 참조하도록 됨(새로운 주소값을 부여 받는다.==주소값 변경)
