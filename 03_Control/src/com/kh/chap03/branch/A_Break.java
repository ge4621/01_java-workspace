...
public class A_Break {
	...
	/*
	 * break; : 반복문 안에 사용되는 분기문 break;가 실행되는 순간 현재 속해있는 반복문을 강제로 빠져나간다.
	 * 
	 * *유의사항 : switch문 안의 break;는 단지 switch문만을 빠져나가는 구문
	 */
	public void method1() {
		// 랜덤값(1~100)발생 시키고 그 랜덤값 출력(이 과정을 매번 반복 => 무한반복)
		// 단, 발생된 랜덤값이 3의 배수 일경우 (3으로 나눴을때 나머지가 0일 경우)반복문을 빠져나와보자
	...
	public void method2() {
		// 사용자에게 문자열을 입력 받아 해아 그 문자열의 길이 출력(무한반복)
		// 단, 사용자가 입력한 문자열이 "exit"일 경우 반복문을 빠져나가도록 설정
	...
	public void method3() {
		...
		while (true) {
			System.out.print("단(2~9)을 입력해 주세요. : ");
			int dan = sc.nextInt();
