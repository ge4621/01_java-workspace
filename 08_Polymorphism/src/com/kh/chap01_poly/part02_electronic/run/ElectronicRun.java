...
public class ElectronicRun {
		...
		public static void main(String[] args) {
			...
			// 1.다형성을 적용 안했을 경우(ElectronicShop1)
			...
			*/
			...
			es.insert(new Desktop("Samsung", "데탑",2000000,"gtx"));
			
			es.insert(new NoteBook("LG", "그램",2000000, 4));
			
			es.insert(new Tablet("Apple", "아이패드", 1500000, false));
			...
			//실제로 들어 있는 값은 Desktop 객체가 맞으나 반환형이 Electronic이라서 맞춰줘야 함!! => 강제형변환해라
			...
			*/
			...
			System.out.println(es.select(0)/*.toString()*/);
			
			/*
			 * 다형성을 사용하는 이유
			 * 1. 부모타입 배열로 다양한 자식객체들을 받을 수 있음
			 * 2. 메소드 정의 시 매개변수로 다형성을 적용하게 되면 메소드 개수가 확 줄어든다.
